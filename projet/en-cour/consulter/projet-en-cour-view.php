...
if ($_GET) {
    ...
    if($rowStatement <= 0){
        header("Location:/crowdcash/projet/en-cour");
        exit();
    }
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="/crowdcash/projet/en-cour/">Projets en cour</a></div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 'Projet finalise') {
                    ...
                    swal.fire({
                        title: 'Finalisé',
                        text: 'Le projet à été finalisé avec succès',
                        icon: 'success',
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 'Projet rejete') {
                    ...
                    swal.fire({
                        title: 'Rejeté',
                        text: 'Le projet à été Rejeté avec succès',
                        icon: 'success',
                        showCancelButton: false,
                        buttons: true,
                        dangerMode: true,
