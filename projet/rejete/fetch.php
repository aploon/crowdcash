...
$colonne = array("date_publication_projet", "date_fin_projet", "info_projet", "nom_secteur", "nom_projet", "nom_personne", "montant_collecte_projet", "montant_total_projet");

$query = '';

$output = array();

$query .= "SELECT * FROM projet, promoteur, secteur, personne WHERE projet.id_promoteur_fk_projet = promoteur.id_promoteur AND projet.id_secteur_fk_projet = secteur.id_secteur AND promoteur.id_personne_fk_promoteur = personne.id_personne AND etat_projet = 'rejete'"; // changer
...
{
    $statement = $db->prepare("SELECT * FROM projet, promoteur, secteur, personne WHERE projet.id_promoteur_fk_projet = promoteur.id_promoteur AND projet.id_secteur_fk_projet = secteur.id_secteur AND promoteur.id_personne_fk_promoteur = personne.id_personne AND etat_projet = 'rejete'"); // same query as above
    $statement->execute();
